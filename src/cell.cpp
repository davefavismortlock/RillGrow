...
// Sets this cell's initial soil surface elevation. Note that it must be called only at the start of the simulation (or when adjusting the edge m_Cells during the simulation), because it doesn't calculate either erosion or deposition
